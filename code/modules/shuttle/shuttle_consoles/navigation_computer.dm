/obj/machinery/computer/camera_advanced/shuttle_docker
	...
	var/y_offset = 0
	var/list/whitelist_turfs = list(/turf/open/space, /turf/open/floor/plating, /turf/open/lava, /turf/open/openspace, /turf/open/misc, /turf/open/water/) //MASSMETA EDIT ORIGINAL (Waterplanet): var/list/whitelist_turfs = list(/turf/open/space, /turf/open/floor/plating, /turf/open/lava, /turf/open/openspace, /turf/open/misc)
